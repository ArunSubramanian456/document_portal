...
class ModelLoader:
    ...
    def _validate_env(self):
        ...
        if missing:
            log.error("Missing evironment variables", missing_vars = missing)
            raise DocumentPortalException(f"Missing environment variables", sys)
        log.info("Environment variables validated successfully", available_keys = [k for k in self.api_keys if self.api_keys[k]])
