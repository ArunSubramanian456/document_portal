...
class DocumentHandler:
    ...
    def __init__(self, data_dir=None, session_id=None):
        try:
            ...
            raise DocumentPortalException(f"Error initializing PDFHandler", sys)
    ...
    def save_pdf(self, uploaded_file):
        try:
            ...
            raise DocumentPortalException(f"Error saving PDF", sys)
    ...
    def read_pdf(self, pdf_path:str)->str:
        try:
            ...
            raise DocumentPortalException(f"Error reading PDF", sys)
